  ...
  <div class="navbar-inverse">
    <div class="container">
      <ul class="nav navbar-nav navbar-left">
        ...
        <?php if(is_array($barMenus)): foreach($barMenus as $key=>$barMenu): ?><li><a href="/R-CMS/index.php?c=cat&id=<?php echo ($barMenu["menu_id"]); ?>" <?php if($_GET['id'] == $barMenu['menu_id']): ?>class="curr"<?php else: ?>class=""<?php endif; ?>><?php echo ($barMenu["name"]); ?></a></li><?php endforeach; endif; ?>
      </ul>
    </div>
  </div>
</header>
