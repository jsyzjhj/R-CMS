...
<script>
    ...
    var SCOPE = {
        'add_url' : '/R-CMS/admin.php?c=menu&a=add',
        'edit_url' : '/R-CMS/admin.php?c=menu&a=edit',
        'set_status_url' : '/R-CMS/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/R-CMS/admin.php?c=menu&a=listorder',
