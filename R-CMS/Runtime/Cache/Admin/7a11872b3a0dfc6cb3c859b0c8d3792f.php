            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="rcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="textarea" name="description" class="form-control" id="inputdescription" placeholder="请填写描述内容">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/R-CMS/admin.php?c=position&a=insert',
        'jump_url' : '/R-CMS/admin.php?c=position&a=add',
    }
</script>
