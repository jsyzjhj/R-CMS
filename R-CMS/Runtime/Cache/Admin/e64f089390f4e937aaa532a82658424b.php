	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>  <a href="/R-CMS/admin.php?c=positioncontent">推荐位内容管理</a>
					</li>
					<li class="active">
			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="rcms-form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题" value="<?php echo ($contents["title"]); ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<img id="upload_org_code_img" src="<?php echo ($contents["thumb"]); ?>" width="150" height="150">
							<input id="file_upload_image" name="thumb" type="hidden" multiple="true" value="<?php echo ($contents["thumb"]); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="请url地址" value="<?php echo ($contents["url"]); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input type="text" name="news_id" class="form-control" id="inputname" placeholder="如果和文章无关联的可以不添加文章id" value="<?php echo ($contents["news_id"]); ?>">
						</div>
					</div>
					<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">状态:</label>
					<div class="col-sm-5">
						<input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($contents['status'] == 1): ?>checked<?php endif; ?>> 开启
						<input type="radio" name="status" id="optionsRadiosInline2" value="0" <?php if($contents['status'] == 0): ?>checked<?php endif; ?>> 关闭
					</div>
...
<script>
	var SCOPE = {
		'save_url' : '/R-CMS/admin.php?c=positioncontent&a=add',
		'jump_url' : '/R-CMS/admin.php?c=positioncontent&a=index',
		'ajax_upload_image_url' : '/R-CMS/admin.php?c=image&a=ajaxuploadimage',
		'ajax_upload_swf' : '/R-CMS/Public/js/party/uploadify.swf'
	};
</script>
<!-- /#wrapper -->
<!-- <script type="text/javascript" src="/R-CMS/Public/js/admin/form.js"></script> -->
