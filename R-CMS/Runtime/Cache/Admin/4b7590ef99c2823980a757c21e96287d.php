...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
		<div class="col-lg-12">
			<a href="/R-CMS/admin.php?c=basic"><button type="button" class="btn btn-primary"> 基本配置</button></a>
		</div>
		</div>
		<!-- /.row -->
...
<script>
	var SCOPE = {
		'save_url' : '/R-CMS/admin.php?c=basic&a=add',
		'jump_url' : '/R-CMS/admin.php?c=basic',
	};
